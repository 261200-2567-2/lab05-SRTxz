public class Sharpshooters implements Sharpshooter {
    String name;
    int level;
    ...
    public void shoot(Knights enemy) {
    ...
    public Sharpshooters(String name,int lv, double hp, double mana,double runSpeed, double damage) {
        this.name = name;
        this.level = lv;
        this.hp = hp;
        this.mana = mana;
